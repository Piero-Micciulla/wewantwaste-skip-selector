...
This project is a React-based application designed to allow users to select and view skip hire information based on a location. It fetches data from an external API, displays it in a user-friendly format, and offers interaction options like selecting a skip and proceeding to the next action. The application has been designed with accessibility, code readability, and best practices in mind.
...
•**Usage**: The icons are used throughout the app, including in the skip information and UI buttons, to improve user experience.
...
•The error state is typed as a string | null to ensure type safety.
...
•http://localhost:5173/?postcode=CB1 0LD&area=Cambridge

•http://localhost:5173/?postcode=EH1 1YZ&area=Edinburgh
